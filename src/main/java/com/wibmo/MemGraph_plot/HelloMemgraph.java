package com.wibmo.MemGraph_plot;
...
public class HelloMemgraph implements AutoCloseable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (var helloMemgraph = new HelloMemgraph("bolt://192.168.8.130:7687", "memgraph", "memgraph")) {
            // Create indexes
    ...
    public void createNodesAndRealationships() {
        ...
        List<String> relationships = Arrays.asList(
                ...
                "MATCH (a:Technology {id: 2}),(b:Technology {id: 5}) CREATE (a)-[r:INHERIT]->(b);",
                "MATCH (a:Technology {id: 3}),(b:Technology {id: 1}) CREATE (a)-[r:WORKER]->(b);"
        );
